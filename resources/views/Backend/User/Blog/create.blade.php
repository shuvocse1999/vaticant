                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='blog_title'  id='blog_title' value='' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='blog_title_italic'  id='blog_title_italic' value='' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='meta_tag'  id='' value='' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  type='text' name='meta_title'  id='' value='' />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea name="meta_description" id="" cols="10" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group-addon">
                                <i class="fa fa-image"></i>
                                </div><input class="form-control"  type='text'  name='alter_image'  id='alter_image' ></div>
                            </div>
                        </div>
